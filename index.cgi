...
console.log('<form method="get"><input type="hidden" name="at" value="' + (at - 100) + '"><input type="submit" value="-100&#x202F;m"></form>')
console.log('<form method="get"><input type="hidden" name="at" value="' + (at - 25) + '"><input type="submit" value="-25&#x202F;m"></form>')
console.log(at + '&#x202F;m')
console.log('<form method="get"><input type="hidden" name="at" value="' + (at + 25) + '"><input type="submit" value="+25&#x202F;m"></form>')
console.log('<form method="get"><input type="hidden" name="at" value="' + (at + 100) + '"><input type="submit" value="+100&#x202F;m"></form>')
console.log('</div>')
